#!/usr/bin/env python3
"""
Recupero codici sconto Comet da shopilo.it
Sursa: https://shopilo.it/negozi/comet.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/comet.it"
STORE_NAME = "Comet"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Comet da shopilo.it"""
    headers = {
